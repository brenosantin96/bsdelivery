    ...
    return (
        <div className={styles.container}>
            <div className={styles.button}
                ...
                style={{ color: canRemove ? '#FFF' : '#96A3AB', backgroundColor: canRemove ? color : '#F2F4F5', width: small ? 42 : 48, height: small ? 42 : 48 }}
            >-</div>
            ...
            <div className={styles.button}
                onClick={handleAdd}
                style={{ color: canAdd ? '#FFF' : '#96A3AB', backgroundColor: canAdd ? color : '#F2F4F5', width: small ? 42 : 48, height: small ? 42 : 48 }}
            >+</div>
        </div>
    )
}